...
# LABEL net.clojars.practicalli.practicalli.random-function-slack-app="practicalli random-function-slack-app"
# LABEL io.github.practicalli.team="Practicalli Engineering Team"
# LABEL version="0.1.0-SNAPSHOT"
# LABEL description="practicalli random-function-slack-app service"
...
WORKDIR /service
COPY --from=builder /build/target/practicalli-random-function-slack-app-standalone.jar /service/
...
CMD ["java", "-jar", "/service/practicalli-random-function-slack-app-standalone.jar"]
